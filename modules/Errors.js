...
module.exports.cmdError = (message) => {
    const cmdEmbed = new Discord.RichEmbed()
        .setColor("RED")
        .setTitle("Oops!")
        .setDescription("**There was a problem running that command.** My devs have been bugged about it. If it isn't fixed, contact them directly by email: finderbotdevs@winmail.windevstudios.cf");
...
module.exports.MissingLogChannel = (message) => {
    const MissingEmbed = new Discord.RichEmbed()
        .setColor("RED")
        .setTitle("Oops!")
        .setDescription("**I couldn't find the logs channel for the solicited request.**");
...
module.exports.SelfError = (message) => {
    const selfEmbed = new Discord.RichEmbed()
        .setColor("RED")
        .setDescription("**I don't think that is how things work...** You provided incorrect args.");
